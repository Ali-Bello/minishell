...
PARSER_SRCS = PARSER/expand.c PARSER/expand_utils.c PARSER/expand_utils2.c PARSER/expand_delayed.c PARSER/parser.c PARSER/ft_free.c\
			PARSER/tree.c PARSER/wildcard.c PARSER/wildcard_utils.c PARSER/parser_utils.c PARSER/parser_utils2.c PARSER/errors.c PARSER/errors_syntax.c
